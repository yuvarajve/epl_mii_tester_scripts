...
/*==========================================================================*/
/**
* reset error registerm is function in order to reset the error values and error registers
*
* \param none
* \return none
**/
...
/*==========================================================================*/
/**
* send_emergency_message is the function in order to transmit error messages
