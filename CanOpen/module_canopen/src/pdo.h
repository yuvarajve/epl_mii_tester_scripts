...
/*==========================================================================*/
/**
* find_pdo_cob_id is the function in order to find cob id of pdo from the
* object dictionary.
*
...
/*==========================================================================*/
/**
* transmit_pdo_data is the function in order to transmit pdo data on to the
* canbus.
*
...
/*==========================================================================*/
/**
* read_pdo_data_from_od is the function in order to read pdo data from the
* object dictionary.
*
* \param comm_parameter pdo communication parameter
* \param mapping_parameter pdo mapping parameter
...
/*==========================================================================*/
/**
* receive_application_data is the function to receive pdo data from the
* application.
*
...
/*==========================================================================*/
/**
* find_pdo_transmission_type is the function to find the tarnsmission type of
* pdo.
*
...
/*==========================================================================*/
/**
* send_pdo_data_to_application is the function to transmit pdo data to the
* application.
*
* \param mapping_parameter pdo mapping parameter
...
/*==========================================================================*/
/**
* write_pdo_data_to_od is the function in order to write pdo data to the
* object dictionary.
*
...
/*==========================================================================*/
/**
* find_pdo_event_type is the function to find the event type of
* pdo.
*
* \param address address of the pdo
* \return pdo_tx_type returns transmit type of the pdo
...
/*==========================================================================*/
/**
* find_pdo_inhibit_time is the function to find the inhibit time of
* pdo.
*
* \param address address of the pdo
* \return pdo_tx_type returns transmit type of the pdo
